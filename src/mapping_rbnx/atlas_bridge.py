...
def init(cfg: dict):
    ...
    _mode = persist.get("map_mode") or str(cfg.get("map_mode", "mapping"))
    lifecycle.set_state(persist.get("map_id", ""), _mode,
                        bump=(_mode == "mapping"))
    try:
    ...
    # the lifecycle broadcast above carries — computing it twice invites
    # the two views of "current mode" to drift apart under a later edit.
    map_ops.set_current_mode(_mode)
